 ...
 *  test announcements
 * @property {number} batchSize The amount of announcements to trigger per interval.
 */
 ...
 * @property {number} globalVolume the global volume gain of all used audio
 * @property {string} channel The channel to track announcements for
 */
