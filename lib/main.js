/*
 ...
 DONE: Provide a queue of followers
 DONE: announceNewFollowers() --> queue manager
 DONE: announceNewFollower() --> called by queue manager (overrideable)
 DONE: done() --> a callback function to let the queue manager to know that the next follower may be announced
 TODO: Notice if the JSONP times out
 TODO: Get channel name from config.js instead of hash part
 */
