...
Nameplate.prototype.tick = function(dTime) {
    ...
    if (!this.closed) {
        this.openProgress += (dTime / 1000);
        this.openProgress = Math.min(this.openProgress, 1);
        var degrees = -180 * this.openProgress;
        this.coverDiv.style.transform = 'perspective(600px) rotateX(' + degrees + 'deg)';
    }
};
